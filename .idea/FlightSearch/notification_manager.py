...
class NotificationManager:
    ...
    def send_sms(self, message_body):
        ...
        This function takes a message body as input and uses the Twilio API to send an text from
        a predefined virtual number (provided by Twilio) to your own "verified" number on Whatsapp.
